...
namespace WCF_Service
{
    ...
    public class ProductService : IProductService
    {
        ...
        public SubCategoryDTO GetSubCategoryByID(int SubCategoryID)
        {
            ...
            try
            {
                if (db.ProductSubCategories.Where(sc => sc.SubCategoryID == SubCategoryID).Count() > 0)
                {
                ...
                {
                    results = new SubCategoryDTO();
                    results.SubCategoryID = 0;
                }
            }
            catch (Exception e)
            {
        ...
        public void AddProduct(ProductDTO product)
        {
            ...
            if (product != null ||
                ...
                db.ProductSubCategories.Where(sc => sc.SubCategoryID == product.SubCategoryID).Count() > 0)
            {
                try
                {
            ...
            {
                throw new FaultException("Product Validation failed");
            }
        }
